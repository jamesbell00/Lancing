            ...
            <View style={styles.body}>
                <ScrollView showsVerticalScrollIndicator={false}>
                    ...
                    <View style={{flexDirection: 'row', justifyContent: 'space-between',padding:5}}>
                        <Image style={{width: 100, height: 100, borderRadius: 20, justifyContent: 'center', alignItems: 'center'}} source={props.item.logo} />
                        <Icon name="bookmark-border" size={25} color={theme.colors.black} style={{left:99}} />
                    </View>            
                        ...
                        <View style={{flexDirection: 'row', justifyContent: 'space-between',padding:5}}>
                             ...
                             <CommunityIcon name="twitter" size={18} color={theme.colors.black} />
                             <CommunityIcon name="facebook" size={18} color={theme.colors.black} />
                             <CommunityIcon name="linkedin" size={18} color={theme.colors.black} />                    
                        </View>
                ...
                <View style={{flexDirection: 'column', justifyContent: 'space-between',padding:10, marginBottom: 20}}>
                ...
                {/* Footer */}
                <View style={{flexDirection: 'row'}}>
                    <View style={[styles.btnContainer, {backgroundColor: theme.colors.blueGrey, borderWidth: 1, borderColor: theme.colors.silver}]}>
                    ...
                    <View style={[styles.btnContainer, {flex: 1,backgroundColor: theme.colors.black, marginLeft: 5}]}>
                        <Text style={[styles.jobTitle, {color: theme.colors.white, marginTop: 0}]}>Invite</Text>
                    </View>
                </View>
            </View>
        </View>
