...
export const q_getJobSkills="select  js.job_id as id,  sc.category_name as category, ss.subcategory_name as subcategory, ss.subcategory_id as subcat_id, s.skill_name as skill from Job_Skills js join Skill_Categories sc on sc.category_id= js.category_id  join Skill_Subcategories ss on ss.subcategory_id=js.subcategory_id join Skills s on s.skill_id=js.skill_id where js.job_id=? and js.category_id=sc.category_id and js.subcategory_id= ss.subcategory_id and s.category_id=js.category_id and s.subcategory_id=js.subcategory_id and js.skill_id=s.skill_id and sc.category_id=ss.category_id group by js.job_id, sc.category_name, ss.subcategory_name, s.skill_name, ss.subcategory_id order by category, ss.subcategory_id"
